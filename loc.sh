...
echo "Total PD3 LoC = $(( $TOTALC_NE + $TOTALH_NE + $TOTALC_TE + $TOTALH_TE + $TOTALC_PRE + $TOTALH_PRE + $TOTALC_BU + $TOTALH_BU + $TOTALC_LZ + $TOTALH_LZ + $TOTALC_RB + $TOTALH_RB + $TOTALC_LIB_COMMON + $TOTALH_LIB_COMMON + $TOTALC_EXEC + $TOTALH_EXEC ))"
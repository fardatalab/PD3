...
## Description
PD3 is a memory disaggregation solution that avoids cache misses via DPU-assisted prefetching. More details can be found in our [NSDI 2026](https://www.usenix.org/conference/nsdi26/presentation/sankhe) [paper](https://fardatalab.org/nsdi26-pd3.pdf).
...
- At least 2 dedicated machines (1 for compute, 1 for memory and remote clients) : Dell PowerEdge R7625 servers with AMD EPYC CPUs (24 cores @ 2.90 GHz) and 128GB DDR5 memory, running Ubuntu 22.04

...
#define GET_BYTE(V, N)	((uint8_t)((V) >> ((N) * 8) & 0xFF))    /* Retrieves the Nth LSB as a byte value */
#define SET_BYTE(V, N)	(((V) & 0xFF)  << ((N) * 8))            /* Sets the given byte value in the Nth LSB position */

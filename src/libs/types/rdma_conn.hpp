...
static constexpr size_t RD_CACHELINE_SIZE = 64;

struct alignas(RD_CACHELINE_SIZE) RdmaRequest {
...
struct alignas(RD_CACHELINE_SIZE) RdmaRequestBatch {
...
struct alignas(RD_CACHELINE_SIZE) RdmaIOContext {
...
struct alignas(RD_CACHELINE_SIZE) RdmaIORequest {
...
struct alignas(RD_CACHELINE_SIZE) RdmaConnection {

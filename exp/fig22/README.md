...
On the client node:
- Run the client process: `~/garnet/fig22.sh `. This will print out the throughput of the Garnet application using only 128M of local memory, with the rest on remote memory

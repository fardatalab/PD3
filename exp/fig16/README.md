...
On the client node:
- Run the client process: `~/hashmap/fig16.sh SYNC_RDMA ~/fig16`. This will generate result files under the supplied directory
...
On the client node:
- Run the client process: `~/hashmap/fig16.sh REDY ~/fig16`. This will generate result files under the supplied directory
...
On the client node:
- Run the client process: `~/hashmap/fig16.sh <num_threads> PD3 ~/fig16`. This will generate result files under the supplied directory. `<num_threads>` will be 1, 2, 4 and 8.

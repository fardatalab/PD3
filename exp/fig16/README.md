This figure compares the latency for the YCSB Zipf workload for the hashmap application. 
...
On the client node:
- Navigate to the experiment directory: `cd ~/exp/fig16`
- Run the client process: `./run.sh SYNC_RDMA`. This will generate result files under the `~/exp/fig16` directory
...
On the client node:
- Navigate to the experiment directory: `cd ~/exp/fig16`
- Run the client process: `~/run.sh REDY`. This will generate result files under the `~/exp/fig16` directory
...
On the client node:
- Navigate to the experiment directory: `cd ~/exp/fig16`
- Run the client process: `./run.sh LEAP`. This will generate result files under the `~/exp/fig16` directory
...
On the client node:
- Navigate to the experiment directory: `cd ~/exp/fig16`
- Run the client process: `./run_pd3.sh <num_threads>`. This will generate result files under the `~/exp/fig16` directory. `<num_threads>` will be 1, 2, 4 and 8.

...
On the client node:
- Run the client process: `~/garnet/fig14.sh SYNC_RDMA ~/fig14`. This will generate result files under the supplied directory
...
On the client node:
- Run the client process: `~/garnet/fig14.sh REDY ~/fig14`. This will generate result files under the supplied directory
...
On the client node:
- Run the client process: `~/hashmap/fig14.sh <num_threads> PD3 ~/fig14`. This will generate result files under the supplied directory. `<num_threads>` will be 1, 2, 4 and 8.

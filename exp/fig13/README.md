...
On the client node:
- Navigate to the experiment directory: `cd ~/exp/fig13`
- Run the client process: `./run.sh SYNC_RDMA`. This will generate result files under the `~/exp/fig13` directory
...
On the client node:
- Navigate to the experiment directory: `cd ~/exp/fig13`
- Run the client process: `./run.sh REDY`. This will generate result files under the `~/exp/fig13` directory
...
On the client node:
- Navigate to the experiment directory: `cd ~/exp/fig13`
- Run the client process: `./run.sh LEAP`. This will generate result files under the `~/exp/fig13` directory
...
On the client node:
- Run the warm-up process: `~/page_server/warmup.sh`
...
On the client node:
- Navigate to the experiment directory: `cd ~/exp/fig13`
- Run the client process: `./run_pd3.sh <num_threads>`. This will generate result files under the `~/exp/fig13` directory. `<num_threads>` will be 1, 2, 4 and 8.

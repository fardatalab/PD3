...
On the client node:
- Run the client process: `~/hashmap/fig12.sh SYNC_RDMA ~/fig12`. This will generate result files under the supplied directory
...
On the client node:
- Run the client process: `~/hashmap/fig12.sh REDY ~/fig12`. This will generate result files under the supplied directory
...
On the client node:
- Run the client process: `~/hashmap/fig12.sh <num_threads> PD3 ~/fig12`. This will generate result files under the supplied directory. `<num_threads>` will be 1, 2, 4 and 8.
